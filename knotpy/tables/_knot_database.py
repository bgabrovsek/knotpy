...
# from knotpy.tables.diagram_reader import load_diagrams_as_dict
...
#         load_function=partial(load_invariant_table, filename=_DATA_DIR / filename, evaluate=False),
#         eval_function=_evaluate_dictionary
#     )
#
# def _lazy_load_diagrams_from_invariants(filename):
#     return LazyLoadEvalDict(
#         load_function=partial(load_invariant_table, filename=_DATA_DIR / filename, evaluate=False, only_field_name="native notation"),
#         eval_function=lambda _: freeze(from_knotpy_notation(_))
#     )
#
# def _lazy_load_diagrams(filename):
#     return LazyLoadEvalDict(
#     load_function=partial(load_diagrams_as_dict, filename=_DATA_DIR / filename, evaluate=False),
#     eval_function=lambda _: freeze(from_knotpy_notation(_))
#     )
#
